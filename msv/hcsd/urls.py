...
urlpatterns = [
    ...
    path('weed-removal/<int:pk>/delete-location/', views.weed_delete_location, name='weed_delete_location'),
    ...
    path('garden/log/', views.garden_change_log, name='garden_change_log'),
